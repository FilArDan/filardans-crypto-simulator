...
export const COINS_DEFAULT = {
  ...
  BYN: { name:'Беларусский Рубль', price:0.36,  basePrice:0.30,  vol:.045, col:'#3a7abf', supply:18500000000 },
};
export const SYMS = Object.keys(COINS_DEFAULT);
export const FEE  = 0.01;
export const START_CASH = 10000;
export const PD_MAX = 300;
